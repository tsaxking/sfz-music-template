...
interface PdfJsTextLayerRenderTask {
    promise: Promise<void>;
    cancel(): void;
}

interface PdfJsTextLayerRenderParameters {
...
interface PdfJsAnnotationLayerRenderTask {
    promise: Promise<void>;
    cancel(): void;
}

interface PdfJsAnnotationLayerRenderParameters {
...
interface PdfJsAnnotationAction {
...
interface PdfJsAnnotationActionHandler {
    action: string;
    title: string;
    eventType: string;
    ref: PdfJsRef;
...
interface PdfJsDownloadManager {
...
interface PdfJsAnnotationLayer {
